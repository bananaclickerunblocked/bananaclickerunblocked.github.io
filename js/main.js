...
$(document).ready(function () {
    ...
    function newActivity() {
        ...
        var avatars = ['https://bananaclickerunblocked.github.io/img/banana.jpg',
            'https://bananaclickerunblocked.github.io/img/banana.jpg'];
        ...
        $('.activityContent').hide().prepend('<div class="live-stats">' +
            ...
            '<div class="info">' +
            '<ul>' +
            '<li><b>' + user + ',</b> scored now:</li>' +
            '<li><img class="item-gen" src="img/banana.jpg" alt="" />Bananas: <span class="bucks-color">' + vBucksRand + '</span> </li>' +
            '</ul>' +
            '</div>' +
            '</div>').fadeIn();
    }
    ...
    function progressBar() {
        ...
        function frame() {
            ...
            if (width == 30) $('.load-textJS').html('Fetching game');
            ...
            if (width == 70) $('.load-textJS').html('LOAD => GAME');
